 ...
 */
final class Version20220906101329 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE structures (id INT AUTO_INCREMENT NOT NULL, partners_id INT DEFAULT NULL, store_name VARCHAR(50) NOT NULL, director_name VARCHAR(50) NOT NULL, email VARCHAR(180) NOT NULL, adress VARCHAR(70) NOT NULL, country VARCHAR(50) NOT NULL, description VARCHAR(255) NOT NULL, phone VARCHAR(25) NOT NULL, image VARCHAR(255) NOT NULL, is_active TINYINT(1) NOT NULL, permission_newsletter TINYINT(1) NOT NULL, permission_planning TINYINT(1) NOT NULL, permission_promote TINYINT(1) NOT NULL, permission_products TINYINT(1) NOT NULL, permission_statistics TINYINT(1) NOT NULL, permission_evenements TINYINT(1) NOT NULL, permission_digicode TINYINT(1) NOT NULL, INDEX IDX_5BBEC55ABDE7F1C6 (partners_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
